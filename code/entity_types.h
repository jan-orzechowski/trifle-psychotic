...
enum class entity_flags
{
	...
	GATE =							(1 << 3),
	SWITCH =						(1 << 4),
	MOVING_PLATFORM_VERTICAL =		(1 << 5),
	MOVING_PLATFORM_HORIZONTAL =	(1 << 6),
	INDESTRUCTIBLE =				(1 << 7),
	DAMAGES_PLAYER =				(1 << 8),
	PLAYER_RECOIL_ON_CONTACT =		(1 << 9),
	DESTRUCTION_ON_PLAYER_CONTACT = (1 << 10),
	WALKS_HORIZONTALLY =			(1 << 11),
	FLIES_HORIZONTALLY =			(1 << 12),
	FLIES_VERTICALLY =				(1 << 13),
	FLIES_TOWARDS_PLAYER =			(1 << 14),
	POWER_UP =						(1 << 15),
	MESSAGE_DISPLAY =				(1 << 16),
	TINTED_DISPLAY =				(1 << 17),
};
