...
chunk_position get_tile_chunk_pos(tile_position tile_pos)
{
...
{
    chunk_position result = get_tile_chunk_pos(get_tile_pos_from_world_pos(world_pos));
    return result;
}
...
world_position get_world_pos_from_tile_pos(tile_position tile_pos)
{
    ...
    result.chunk_pos = get_tile_chunk_pos(tile_pos);
    result.pos_in_chunk = get_tile_offset_in_chunk(result.chunk_pos, tile_pos);
    return result;
}

world_position get_world_pos_from_pos_in_chunk(chunk_position chunk_pos, v2 pos_in_chunk)
{
    world_position result = {0};
...
world_position get_world_pos_from_chunk(chunk_position chunk_pos)
{
    world_position result = {0};
    result.chunk_pos = chunk_pos;
    return result;
...
v2 get_world_position_difference(world_position a, world_position b)
{
...
v2 get_world_pos_and_chunk_position_difference(world_position a, chunk_position b)
{
    v2 result = get_world_position_difference(a, get_world_pos_from_chunk(b));
    return result;
}

v2 get_chunk_and_world_position_difference(chunk_position a, world_position b)
{
    v2 result = get_world_position_difference(get_world_pos_from_chunk(a), b);
    return result;
}

v2 get_world_pos_and_tile_position_difference(world_position a, tile_position b)
{
    v2 result = get_world_position_difference(a, get_world_pos_from_tile_pos(b));
    return result;
}

v2 get_tile_pos_and_world_position_difference(tile_position a, world_position b)
{
    v2 result = get_world_position_difference(get_world_pos_from_tile_pos(a), b);
    return result;
}

v2 get_tile_pos_and_chunk_position_difference(tile_position a, chunk_position b)
{
    v2 result = get_world_position_difference(get_world_pos_from_tile_pos(a), get_world_pos_from_chunk(b));
    return result;
}

world_position add_to_world_position(world_position pos, v2 offset)
{
...
v2 get_tile_offset_in_chunk(chunk_position chunk_pos, tile_position tile_pos)
{
    ...
    v2 position_difference = get_tile_position_difference(get_tile_pos(tile_pos.x, tile_pos.y), chunk_origin_tile);
...
{
    r32 end_distance = length_v2(get_tile_pos_and_world_position_difference(range.end, position));
    r32 start_distance = length_v2(get_tile_pos_and_world_position_difference(range.start, position));
